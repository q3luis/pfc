...
models=["/vol/pfc/data/models/sequence_2_oversample_25_11/train_sequence_2_vs_seq3_25_11_50000_iter_20000.caffemodel"]


means=["/vol/pfc/data/means/Sequences_2_Oversample_mean.npy"]

deploys=["/vol/pfc/prototxt/sequence2oversample/train_sequence_25_test3_lmdb_11_deploy.prototxt"]
...
output = open('evaluate_seq2_25_11o_vs_all.pkl', 'wb')
