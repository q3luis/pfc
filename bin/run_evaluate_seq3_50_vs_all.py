...
models=["/vol/pfc/data/models/train_50_batch/train_sequence_3_50_lmdb_iter_35000.caffemodel"]


means=["/vol/pfc/data/means/Sequence3_mean.npy"]

deploys=["/vol/pfc/prototxt/sequence3/train_sequence_50_lmdb_deploy.prototxt"]
...
output = open('evaluate_seq3_50_vs_all.pkl', 'wb')
