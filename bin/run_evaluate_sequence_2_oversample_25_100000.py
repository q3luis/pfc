...
models = ["/vol/pfc/data/models/sequence_2_oversample_25/train_sequence_2_vs_seq3_25_200000_iter_100000.caffemodel"]
...
output = open('evaluate_20_100000_vs_1_3.pkl', 'wb')
