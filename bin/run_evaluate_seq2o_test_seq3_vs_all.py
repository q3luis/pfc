...
models=["/vol/pfc/data/models/sequence_2_oversample_25/train_sequence_2_vs_seq3_25_100000_iter_50000.caffemodel",
    "/vol/pfc/data/models/sequence_2_oversample_50/train_sequence_2_vs_seq3_50_100000_iter_50000.caffemodel"
        ]

models=["/vol/pfc/data/models/sequence_2_oversample_25/train_sequence_2_vs_seq3_25_100000_iter_100000.caffemodel"]
...
means=["/vol/pfc/data/means/Sequences_2_Oversample_mean.npy",
       "/vol/pfc/data/means/Sequences_2_Oversample_mean.npy"]

deploys=["/vol/pfc/prototxt/sequence2oversample/train_sequence_25_test3_lmdb_deploy.prototxt",
         "/vol/pfc/prototxt/sequence2oversample/train_sequence_50_test3_lmdb_deploy.prototxt"]

#deploys=["/vol/pfc/prototxt/sequence2oversample/train_sequence_50_test3_lmdb_deploy.prototxt"]
...
output = open('evaluate_seq2o_25_100000_test3_vs_seq1.pkl', 'wb')
pickle.dump(X, output)
output.close()

seq_model_label=['seq3_model','seq2_model','seq3_model','seq4_model','seq5_model']
