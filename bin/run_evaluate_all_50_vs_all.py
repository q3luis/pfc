...
means=["/vol/pfc/data/means/Sequence1_mean.npy","/vol/pfc/data/means/Sequence2_mean.npy",
       "/vol/pfc/data/means/Sequence4_mean.npy"
       ,"/vol/pfc/data/means/Sequence5_mean.npy"]

deploys=["/vol/pfc/prototxt/sequence1/train_sequence_50_lmdb_deploy.prototxt",
         "/vol/pfc/prototxt/sequence2/train_sequence_50_lmdb_deploy.prototxt"
        ,"/vol/pfc/prototxt/sequence4/train_sequence_50_lmdb_deploy.prototxt"
        ,"/vol/pfc/prototxt/sequence5/train_sequence_50_lmdb_deploy.prototxt"]
...
output = open('evaluate_all_50_vs_all.pkl', 'wb')
