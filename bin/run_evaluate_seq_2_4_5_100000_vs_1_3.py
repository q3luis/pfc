...
#train_sequence_2_4_5_25_lmdb_iter_35000.caffemodel
import caffe
import lmdb
import numpy as np
...
sequences=["/vol/pfc/data/datasets/Sequence1_lmdb","/vol/pfc/data/datasets/Sequence3_lmdb"]


#models=["/vol/pfc/data/models/sequence_2_4_5_oversample_25/train_sequence_2_4_5_25_lmdb_iter_35000.caffemodel"]


#means=["/vol/pfc/data/means/Sequence_2_4_5.npy"]

#deploys=["/vol/pfc/prototxt/sequence_2_4_5/train_sequence_25_lmdb_deploy.prototxt"]

models=["/vol/pfc/data/models/sequence_2_4_5_oversample_25/train_sequence_2_4_5_25_100000_lmdb_iter_100000.caffemodel" ]
...
output = open('evaluate_2_4_5_100000_over_scikit_vs_1_3.pkl', 'wb')
pickle.dump(X, output)
output.close()

seq_model_label=['seq2_4_5']
